...
const SYSTEMD_SERVICE_NAME: &str = "raspberry-pi-wireless-bootstrap";
const SETUP_SCRIPT_PATH: &str = "/opt/raspberry-pi-wireless-bootstrap.sh";
pub(super) const SETUP_COMPLETE_SCRIPT_PATH: &str = "/opt/raspberry-pi-wireless-bootstrap-complete.sh";
